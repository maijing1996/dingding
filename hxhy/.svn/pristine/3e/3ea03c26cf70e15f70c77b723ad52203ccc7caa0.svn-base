...
public class HxhyAttendance extends BaseEntity {
	...
	private String work_date;//工作日,2018-11-11
	...
	private Integer is_supplement;//是否有补卡记录
	...
	public Integer getIs_supplement() {
		return is_supplement;
	}
	public void setIs_supplement(Integer is_supplement) {
