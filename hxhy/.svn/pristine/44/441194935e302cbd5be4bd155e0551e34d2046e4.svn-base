...
public class HxhyLeaveController {
	...
	public BaseResponse listInfo(@RequestBody Map<String, String> map) {
		...
		PageInfo<AttendanceLeave> pageInfo = hxhyLeaveService.listInfo(StringUtil.strToInt(map.get("page")), 
...
//		}
	...
	public BaseResponse update(@RequestBody HxhyLeave hxhyLeave) throws BusinessException {
		...
		if(hxhyLeave.getDescription() != null) {
			hxhyLeave2.setDescription(hxhyLeave.getDescription());
		}
		hxhyLeave2.setIs_del(hxhyLeave.getIs_del());
		hxhyLeave2.setIs_pay(hxhyLeave.getIs_pay());
