...
import com.hxhy.model.common.DateEntity;
...
public class DateUtil {
	...
	public static int getDays(Date date) {
	    ...
	    int maxDate = cal.get(Calendar.DATE);//获取当月的天数
	 ...
	 * @return
	 */
	public static String getYearMonthy() {
	 ...
	 * 获取传过来的日期年月
	 */
	public static String getYearMonthy2(String date, String format){
		Date date3 = parseDate(date, FORMAT_YYYY_MM_dd);
		String date2 = format(date3, format);
		return date2;
	}
	...
	public static String getYear(String date){
		Date date2 = parseDate(date, FORMAT_YYYY_MM_dd);
		SimpleDateFormat s=new SimpleDateFormat("yyyy");
		String date3 = s.format(date2);  //当前日期
		return date3;
	}
}
